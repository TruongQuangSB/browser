...
pub enum cef_errorcode_t {
    #[doc = " No error."]
    ERR_NONE = 0,
    #[doc = " An asynchronous IO operation is not yet complete.  This usually does not\n indicate a fatal error.  Typically this error will be generated as a\n notification to wait for some external notification that the IO operation\n finally completed."]
    ERR_IO_PENDING = -1,
    #[doc = " A generic failure occurred."]
    ERR_FAILED = -2,
    #[doc = " An operation was aborted (due to user action)."]
    ERR_ABORTED = -3,
    #[doc = " An argument to the function is incorrect."]
    ERR_INVALID_ARGUMENT = -4,
    #[doc = " The handle or file descriptor is invalid."]
    ERR_INVALID_HANDLE = -5,
    #[doc = " The file or directory cannot be found."]
    ERR_FILE_NOT_FOUND = -6,
    #[doc = " An operation timed out."]
    ERR_TIMED_OUT = -7,
    #[doc = " The file is too large."]
    ERR_FILE_TOO_BIG = -8,
    #[doc = " An unexpected error.  This may be caused by a programming mistake or an\n invalid assumption."]
    ERR_UNEXPECTED = -9,
    #[doc = " Permission to access a resource, other than the network, was denied."]
    ERR_ACCESS_DENIED = -10,
    #[doc = " The operation failed because of unimplemented functionality."]
    ERR_NOT_IMPLEMENTED = -11,
    #[doc = " There were not enough resources to complete the operation."]
    ERR_INSUFFICIENT_RESOURCES = -12,
    #[doc = " Memory allocation failed."]
    ERR_OUT_OF_MEMORY = -13,
    #[doc = " The file upload failed because the file's modification time was different\n from the expectation."]
    ERR_UPLOAD_FILE_CHANGED = -14,
    #[doc = " The socket is not connected."]
    ERR_SOCKET_NOT_CONNECTED = -15,
    #[doc = " The file already exists."]
    ERR_FILE_EXISTS = -16,
    #[doc = " The path or file name is too long."]
    ERR_FILE_PATH_TOO_LONG = -17,
    #[doc = " Not enough room left on the disk."]
    ERR_FILE_NO_SPACE = -18,
    #[doc = " The file has a virus."]
    ERR_FILE_VIRUS_INFECTED = -19,
    #[doc = " The client chose to block the request."]
    ERR_BLOCKED_BY_CLIENT = -20,
    #[doc = " The network changed."]
    ERR_NETWORK_CHANGED = -21,
    #[doc = " The request was blocked by the URL block list configured by the domain\n administrator."]
    ERR_BLOCKED_BY_ADMINISTRATOR = -22,
    #[doc = " The socket is already connected."]
    ERR_SOCKET_IS_CONNECTED = -23,
    #[doc = " The upload failed because the upload stream needed to be re-read, due to a\n retry or a redirect, but the upload stream doesn't support that operation."]
    ERR_UPLOAD_STREAM_REWIND_NOT_SUPPORTED = -25,
    #[doc = " The request failed because the URLRequestContext is shutting down, or has\n been shut down."]
    ERR_CONTEXT_SHUT_DOWN = -26,
    #[doc = " The request failed because the response was delivered along with requirements\n which are not met ('X-Frame-Options' and 'Content-Security-Policy' ancestor\n checks and 'Cross-Origin-Resource-Policy' for instance)."]
    ERR_BLOCKED_BY_RESPONSE = -27,
    #[doc = " The request was blocked by system policy disallowing some or all cleartext\n requests. Used for NetworkSecurityPolicy on Android."]
    ERR_CLEARTEXT_NOT_PERMITTED = -29,
    #[doc = " The request was blocked by a Content Security Policy"]
    ERR_BLOCKED_BY_CSP = -30,
    #[doc = " The request was blocked by CORB or ORB."]
    ERR_BLOCKED_BY_ORB = -32,
    #[doc = " The request was blocked because it originated from a frame that has disabled\n network access."]
    ERR_NETWORK_ACCESS_REVOKED = -33,
    #[doc = " The request was blocked by fingerprinting protections."]
    ERR_BLOCKED_BY_FINGERPRINTING_PROTECTION = -34,
    #[doc = " The request was blocked by the Incognito Mode URL block list configured by\n the domain administrator."]
    ERR_BLOCKED_IN_INCOGNITO_BY_ADMINISTRATOR = -35,
    #[doc = " A connection was closed (corresponding to a TCP FIN)."]
    ERR_CONNECTION_CLOSED = -100,
    #[doc = " A connection was reset (corresponding to a TCP RST)."]
    ERR_CONNECTION_RESET = -101,
    #[doc = " A connection attempt was refused."]
    ERR_CONNECTION_REFUSED = -102,
    #[doc = " A connection timed out as a result of not receiving an ACK for data sent.\n This can include a FIN packet that did not get ACK'd."]
    ERR_CONNECTION_ABORTED = -103,
    #[doc = " A connection attempt failed."]
    ERR_CONNECTION_FAILED = -104,
    #[doc = " The host name could not be resolved."]
    ERR_NAME_NOT_RESOLVED = -105,
    #[doc = " The Internet connection has been lost."]
    ERR_INTERNET_DISCONNECTED = -106,
    #[doc = " An SSL protocol error occurred."]
    ERR_SSL_PROTOCOL_ERROR = -107,
    #[doc = " The IP address or port number is invalid (e.g., cannot connect to the IP\n address 0 or the port 0)."]
    ERR_ADDRESS_INVALID = -108,
    #[doc = " The IP address is unreachable.  This usually means that there is no route to\n the specified host or network."]
    ERR_ADDRESS_UNREACHABLE = -109,
    #[doc = " The server requested a client certificate for SSL client authentication."]
    ERR_SSL_CLIENT_AUTH_CERT_NEEDED = -110,
    #[doc = " A tunnel connection through the proxy could not be established. For more info\n see the comment on PROXY_UNABLE_TO_CONNECT_TO_DESTINATION."]
    ERR_TUNNEL_CONNECTION_FAILED = -111,
    #[doc = " The client and server don't support a common SSL protocol version or\n cipher suite."]
    ERR_SSL_VERSION_OR_CIPHER_MISMATCH = -113,
    #[doc = " The server requested a renegotiation (rehandshake)."]
    ERR_SSL_RENEGOTIATION_REQUESTED = -114,
    #[doc = " The proxy requested authentication (for tunnel establishment) with an\n unsupported method."]
    ERR_PROXY_AUTH_UNSUPPORTED = -115,
    #[doc = " The SSL handshake failed because of a bad or missing client certificate."]
    ERR_BAD_SSL_CLIENT_AUTH_CERT = -117,
    #[doc = " A connection attempt timed out."]
    ERR_CONNECTION_TIMED_OUT = -118,
    #[doc = " There are too many pending DNS resolves, so a request in the queue was\n aborted."]
    ERR_HOST_RESOLVER_QUEUE_TOO_LARGE = -119,
    #[doc = " Failed establishing a connection to the SOCKS proxy server for a target host."]
    ERR_SOCKS_CONNECTION_FAILED = -120,
    #[doc = " The SOCKS proxy server failed establishing connection to the target host\n because that host is unreachable."]
    ERR_SOCKS_CONNECTION_HOST_UNREACHABLE = -121,
    #[doc = " The request to negotiate an alternate protocol failed."]
    ERR_ALPN_NEGOTIATION_FAILED = -122,
    #[doc = " The peer sent an SSL no_renegotiation alert message."]
    ERR_SSL_NO_RENEGOTIATION = -123,
    #[doc = " Winsock sometimes reports more data written than passed.  This is probably\n due to a broken LSP."]
    ERR_WINSOCK_UNEXPECTED_WRITTEN_BYTES = -124,
    #[doc = " An SSL peer sent us a fatal decompression_failure alert. This typically\n occurs when a peer selects DEFLATE compression in the mistaken belief that\n it supports it."]
    ERR_SSL_DECOMPRESSION_FAILURE_ALERT = -125,
    #[doc = " An SSL peer sent us a fatal bad_record_mac alert. This has been observed\n from servers with buggy DEFLATE support."]
    ERR_SSL_BAD_RECORD_MAC_ALERT = -126,
    #[doc = " The proxy requested authentication (for tunnel establishment)."]
    ERR_PROXY_AUTH_REQUESTED = -127,
    #[doc = " Could not create a connection to the proxy server. An error occurred\n either in resolving its name, or in connecting a socket to it.\n Note that this does NOT include failures during the actual \"CONNECT\" method\n of an HTTP proxy."]
    ERR_PROXY_CONNECTION_FAILED = -130,
    #[doc = " A mandatory proxy configuration could not be used. Currently this means\n that a mandatory PAC script could not be fetched, parsed or executed."]
    ERR_MANDATORY_PROXY_CONFIGURATION_FAILED = -131,
    #[doc = " We've hit the max socket limit for the socket pool while preconnecting.  We\n don't bother trying to preconnect more sockets."]
    ERR_PRECONNECT_MAX_SOCKET_LIMIT = -133,
    #[doc = " The permission to use the SSL client certificate's private key was denied."]
    ERR_SSL_CLIENT_AUTH_PRIVATE_KEY_ACCESS_DENIED = -134,
    #[doc = " The SSL client certificate has no private key."]
    ERR_SSL_CLIENT_AUTH_CERT_NO_PRIVATE_KEY = -135,
    #[doc = " The certificate presented by the HTTPS Proxy was invalid."]
    ERR_PROXY_CERTIFICATE_INVALID = -136,
    #[doc = " An error occurred when trying to do a name resolution (DNS)."]
    ERR_NAME_RESOLUTION_FAILED = -137,
    #[doc = " Permission to access the network was denied. This is used to distinguish\n errors that were most likely caused by a firewall from other access denied\n errors. See also ERR_ACCESS_DENIED."]
    ERR_NETWORK_ACCESS_DENIED = -138,
    #[doc = " The request throttler module cancelled this request to avoid DDOS."]
    ERR_TEMPORARILY_THROTTLED = -139,
    #[doc = " We were unable to sign the CertificateVerify data of an SSL client auth\n handshake with the client certificate's private key.\n\n Possible causes for this include the user implicitly or explicitly\n denying access to the private key, the private key may not be valid for\n signing, the key may be relying on a cached handle which is no longer\n valid, or the CSP won't allow arbitrary data to be signed."]
    ERR_SSL_CLIENT_AUTH_SIGNATURE_FAILED = -141,
    #[doc = " The message was too large for the transport.  (for example a UDP message\n which exceeds size threshold)."]
    ERR_MSG_TOO_BIG = -142,
    #[doc = " Websocket protocol error. Indicates that we are terminating the connection\n due to a malformed frame or other protocol violation."]
    ERR_WS_PROTOCOL_ERROR = -145,
    #[doc = " Returned when attempting to bind an address that is already in use."]
    ERR_ADDRESS_IN_USE = -147,
    #[doc = " The certificate didn't match the built-in public key pins for the host name.\n The pins are set in net/http/transport_security_state.cc and require that\n one of a set of public keys exist on the path from the leaf to the root."]
    ERR_SSL_PINNED_KEY_NOT_IN_CERT_CHAIN = -150,
    #[doc = " Server request for client certificate did not contain any types we support."]
    ...
    #[doc = " There are too many pending WebSocketJob instances, so the new job was not\n pushed to the queue."]
    ERR_WS_THROTTLE_QUEUE_TOO_LARGE = -154,
    #[doc = " The SSL server certificate changed in a renegotiation."]
    ERR_SSL_SERVER_CERT_CHANGED = -156,
    #[doc = " The SSL server sent us a fatal unrecognized_name alert."]
    ERR_SSL_UNRECOGNIZED_NAME_ALERT = -159,
    #[doc = " Failed to set the socket's receive buffer size as requested."]
    ERR_SOCKET_SET_RECEIVE_BUFFER_SIZE_ERROR = -160,
    #[doc = " Failed to set the socket's send buffer size as requested."]
    ERR_SOCKET_SET_SEND_BUFFER_SIZE_ERROR = -161,
    #[doc = " Failed to set the socket's receive buffer size as requested, despite success\n return code from setsockopt."]
    ERR_SOCKET_RECEIVE_BUFFER_SIZE_UNCHANGEABLE = -162,
    #[doc = " Failed to set the socket's send buffer size as requested, despite success\n return code from setsockopt."]
    ERR_SOCKET_SEND_BUFFER_SIZE_UNCHANGEABLE = -163,
    #[doc = " Failed to import a client certificate from the platform store into the SSL\n library."]
    ERR_SSL_CLIENT_AUTH_CERT_BAD_FORMAT = -164,
    #[doc = " Resolving a hostname to an IP address list included the IPv4 address\n \"127.0.53.53\". This is a special IP address which ICANN has recommended to\n indicate there was a name collision, and alert admins to a potential\n problem."]
    ERR_ICANN_NAME_COLLISION = -166,
    #[doc = " The SSL server presented a certificate which could not be decoded. This is\n not a certificate error code as no X509Certificate object is available. This\n error is fatal."]
    ERR_SSL_SERVER_CERT_BAD_FORMAT = -167,
    #[doc = " Certificate Transparency: Received a signed tree head that failed to parse."]
    ERR_CT_STH_PARSING_FAILED = -168,
    #[doc = " Certificate Transparency: Received a signed tree head whose JSON parsing was\n OK but was missing some of the fields."]
    ERR_CT_STH_INCOMPLETE = -169,
    #[doc = " The attempt to reuse a connection to send proxy auth credentials failed\n before the AuthController was used to generate credentials. The caller should\n reuse the controller with a new connection. This error is only used\n internally by the network stack."]
    ERR_UNABLE_TO_REUSE_CONNECTION_FOR_PROXY_AUTH = -170,
    #[doc = " Certificate Transparency: Failed to parse the received consistency proof."]
    ERR_CT_CONSISTENCY_PROOF_PARSING_FAILED = -171,
    #[doc = " The SSL server required an unsupported cipher suite that has since been\n removed. This error will temporarily be signaled on a fallback for one or two\n releases immediately following a cipher suite's removal, after which the\n fallback will be removed."]
    ERR_SSL_OBSOLETE_CIPHER = -172,
    #[doc = " When a WebSocket handshake is done successfully and the connection has been\n upgraded, the URLRequest is cancelled with this error code."]
    ERR_WS_UPGRADE = -173,
    #[doc = " Socket ReadIfReady support is not implemented. This error should not be user\n visible, because the normal Read() method is used as a fallback."]
    ERR_READ_IF_READY_NOT_IMPLEMENTED = -174,
    #[doc = " No socket buffer space is available."]
    ERR_NO_BUFFER_SPACE = -176,
    #[doc = " There were no common signature algorithms between our client certificate\n private key and the server's preferences."]
    ERR_SSL_CLIENT_AUTH_NO_COMMON_ALGORITHMS = -177,
    #[doc = " TLS 1.3 early data was rejected by the server. This will be received before\n any data is returned from the socket. The request should be retried with\n early data disabled."]
    ERR_EARLY_DATA_REJECTED = -178,
    #[doc = " TLS 1.3 early data was offered, but the server responded with TLS 1.2 or\n earlier. This is an internal error code to account for a\n backwards-compatibility issue with early data and TLS 1.2. It will be\n received before any data is returned from the socket. The request should be\n retried with early data disabled.\n\n See https://tools.ietf.org/html/rfc8446#appendix-D.3 for details."]
    ERR_WRONG_VERSION_ON_EARLY_DATA = -179,
    #[doc = " TLS 1.3 was enabled, but a lower version was negotiated and the server\n returned a value indicating it supported TLS 1.3. This is part of a security\n check in TLS 1.3, but it may also indicate the user is behind a buggy\n TLS-terminating proxy which implemented TLS 1.2 incorrectly. (See\n https://crbug.com/boringssl/226.)"]
    ERR_TLS13_DOWNGRADE_DETECTED = -180,
    #[doc = " The server's certificate has a keyUsage extension incompatible with the\n negotiated TLS key exchange method."]
    ERR_SSL_KEY_USAGE_INCOMPATIBLE = -181,
    #[doc = " The ECHConfigList fetched over DNS cannot be parsed."]
    ERR_INVALID_ECH_CONFIG_LIST = -182,
    #[doc = " ECH was enabled, but the server was unable to decrypt the encrypted\n ClientHello."]
    ERR_ECH_NOT_NEGOTIATED = -183,
    #[doc = " ECH was enabled, the server was unable to decrypt the encrypted ClientHello,\n and additionally did not present a certificate valid for the public name."]
    ERR_ECH_FALLBACK_CERTIFICATE_INVALID = -184,
    #[doc = " An attempt to proxy a request failed because the proxy wasn't able to\n successfully connect to the destination. This likely indicates an issue with\n the request itself (for instance, the hostname failed to resolve to an IP\n address or the destination server refused the connection). This error code\n is used to indicate that the error is outside the control of the proxy server\n and thus the proxy chain should not be marked as bad. This is in contrast to\n ERR_TUNNEL_CONNECTION_FAILED which is used for general purpose errors\n connecting to the proxy and by the proxy request response handling when a\n proxy delegate doesn't indicate via a different error code whether proxy\n fallback should occur. Note that for IP Protection proxies this error code\n causes the proxy to be marked as bad since the preference is to fail open for\n general purpose errors, but for other proxies this error does not cause the\n proxy to be marked as bad."]
    ERR_PROXY_UNABLE_TO_CONNECT_TO_DESTINATION = -186,
    #[doc = " Some implementations of ProxyDelegate query a separate entity to know whether\n it should cancel tunnel prior to:\n - The HTTP CONNECT requests being sent out\n - The HTTP CONNECT response being parsed by //net\n An example is CronetProxyDelegate: Cronet allows developers to decide whether\n the tunnel being established should be canceled."]
    ERR_PROXY_DELEGATE_CANCELED_CONNECT_REQUEST = -187,
    #[doc = " Some implementations of ProxyDelegate query a separate entity to know whether\n it should cancel tunnel prior to:\n - The HTTP CONNECT requests being sent out\n - The HTTP CONNECT response being parsed by //net\n An example is CronetProxyDelegate: Cronet allows developers to decide whether\n the tunnel being established should be canceled."]
    ERR_PROXY_DELEGATE_CANCELED_CONNECT_RESPONSE = -188,
    #[doc = " The server responded with a certificate whose common name did not match\n the host name.  This could mean:\n\n 1. An attacker has redirected our traffic to their server and is\n    presenting a certificate for which they know the private key.\n\n 2. The server is misconfigured and responding with the wrong cert.\n\n 3. The user is on a wireless network and is being redirected to the\n    network's login page.\n\n 4. The OS has used a DNS search suffix and the server doesn't have\n    a certificate for the abbreviated name in the address bar.\n"]
    ERR_CERT_COMMON_NAME_INVALID = -200,
    #[doc = " The server responded with a certificate that, by our clock, appears to\n either not yet be valid or to have expired.  This could mean:\n\n 1. An attacker is presenting an old certificate for which they have\n    managed to obtain the private key.\n\n 2. The server is misconfigured and is not presenting a valid cert.\n\n 3. Our clock is wrong.\n"]
    ERR_CERT_DATE_INVALID = -201,
    #[doc = " The server responded with a certificate that is signed by an authority\n we don't trust.  The could mean:\n\n 1. An attacker has substituted the real certificate for a cert that\n    contains their public key and is signed by their cousin.\n\n 2. The server operator has a legitimate certificate from a CA we don't\n    know about, but should trust.\n\n 3. The server is presenting a self-signed certificate, providing no\n    defense against active attackers (but foiling passive attackers).\n"]
    ERR_CERT_AUTHORITY_INVALID = -202,
    #[doc = " The server responded with a certificate that contains errors.\n This error is not recoverable.\n\n MSDN describes this error as follows:\n   \"The SSL certificate contains errors.\"\n NOTE: It's unclear how this differs from ERR_CERT_INVALID. For consistency,\n use that code instead of this one from now on.\n"]
    ERR_CERT_CONTAINS_ERRORS = -203,
    #[doc = " The certificate has no mechanism for determining if it is revoked.  In\n effect, this certificate cannot be revoked."]
    ERR_CERT_NO_REVOCATION_MECHANISM = -204,
    #[doc = " Revocation information for the security certificate for this site is not\n available.  This could mean:\n\n 1. An attacker has compromised the private key in the certificate and is\n    blocking our attempt to find out that the cert was revoked.\n\n 2. The certificate is unrevoked, but the revocation server is busy or\n    unavailable.\n"]
    ERR_CERT_UNABLE_TO_CHECK_REVOCATION = -205,
    #[doc = " The server responded with a certificate has been revoked.\n We have the capability to ignore this error, but it is probably not the\n thing to do."]
    ERR_CERT_REVOKED = -206,
    #[doc = " The server responded with a certificate that is invalid.\n This error is not recoverable.\n\n MSDN describes this error as follows:\n   \"The SSL certificate is invalid.\"\n"]
    ERR_CERT_INVALID = -207,
    #[doc = " The server responded with a certificate that is signed using a weak\n signature algorithm."]
    ERR_CERT_WEAK_SIGNATURE_ALGORITHM = -208,
    #[doc = " The host name specified in the certificate is not unique."]
    ERR_CERT_NON_UNIQUE_NAME = -210,
    #[doc = " The server responded with a certificate that contains a weak key (e.g.\n a too-small RSA key)."]
    ERR_CERT_WEAK_KEY = -211,
    #[doc = " The certificate claimed DNS names that are in violation of name constraints."]
    ERR_CERT_NAME_CONSTRAINT_VIOLATION = -212,
    #[doc = " The certificate's validity period is too long."]
    ERR_CERT_VALIDITY_TOO_LONG = -213,
    #[doc = " Certificate Transparency was required for this connection, but the server\n did not provide CT information that complied with the policy."]
    ERR_CERTIFICATE_TRANSPARENCY_REQUIRED = -214,
    #[doc = " The certificate is known to be used for interception by an entity other\n the device owner."]
    ERR_CERT_KNOWN_INTERCEPTION_BLOCKED = -217,
    #[doc = " The certificate is self signed and it's being used for either an RFC1918 IP\n literal URL, or a url ending in .local."]
    ERR_CERT_SELF_SIGNED_LOCAL_NETWORK = -219,
    #[doc = " The value immediately past the last certificate error code."]
    ERR_CERT_END = -220,
    #[doc = " The URL is invalid."]
    ERR_INVALID_URL = -300,
    #[doc = " The scheme of the URL is disallowed."]
    ERR_DISALLOWED_URL_SCHEME = -301,
    #[doc = " The scheme of the URL is unknown."]
    ERR_UNKNOWN_URL_SCHEME = -302,
    #[doc = " Attempting to load an URL resulted in a redirect to an invalid URL."]
    ERR_INVALID_REDIRECT = -303,
    #[doc = " Attempting to load an URL resulted in too many redirects."]
    ERR_TOO_MANY_REDIRECTS = -310,
    #[doc = " Attempting to load an URL resulted in an unsafe redirect (e.g., a redirect\n to file:// is considered unsafe)."]
    ERR_UNSAFE_REDIRECT = -311,
    #[doc = " Attempting to load an URL with an unsafe port number.  These are port\n numbers that correspond to services, which are not robust to spurious input\n that may be constructed as a result of an allowed web construct (e.g., HTTP\n looks a lot like SMTP, so form submission to port 25 is denied)."]
    ERR_UNSAFE_PORT = -312,
    #[doc = " The server's response was invalid."]
    ERR_INVALID_RESPONSE = -320,
    #[doc = " Error in chunked transfer encoding."]
    ERR_INVALID_CHUNKED_ENCODING = -321,
    #[doc = " The server did not support the request method."]
    ERR_METHOD_NOT_SUPPORTED = -322,
    #[doc = " The response was 407 (Proxy Authentication Required), yet we did not send\n the request to a proxy."]
    ERR_UNEXPECTED_PROXY_AUTH = -323,
    #[doc = " The server closed the connection without sending any data."]
    ERR_EMPTY_RESPONSE = -324,
    #[doc = " The headers section of the response is too large."]
    ERR_RESPONSE_HEADERS_TOO_BIG = -325,
    #[doc = " The evaluation of the PAC script failed."]
    ERR_PAC_SCRIPT_FAILED = -327,
    #[doc = " The response was 416 (Requested range not satisfiable) and the server cannot\n satisfy the range requested."]
    ERR_REQUEST_RANGE_NOT_SATISFIABLE = -328,
    #[doc = " The identity used for authentication is invalid."]
    ERR_MALFORMED_IDENTITY = -329,
    #[doc = " Content decoding of the response body failed."]
    ERR_CONTENT_DECODING_FAILED = -330,
    #[doc = " An operation could not be completed because all network IO\n is suspended."]
    ERR_NETWORK_IO_SUSPENDED = -331,
    #[doc = " There are no supported proxies in the provided list."]
    ERR_NO_SUPPORTED_PROXIES = -336,
    #[doc = " There is an HTTP/2 protocol error."]
    ERR_HTTP2_PROTOCOL_ERROR = -337,
    #[doc = " Credentials could not be established during HTTP Authentication."]
    ERR_INVALID_AUTH_CREDENTIALS = -338,
    #[doc = " An HTTP Authentication scheme was tried which is not supported on this\n machine."]
    ERR_UNSUPPORTED_AUTH_SCHEME = -339,
    #[doc = " Detecting the encoding of the response failed."]
    ERR_ENCODING_DETECTION_FAILED = -340,
    #[doc = " (GSSAPI) No Kerberos credentials were available during HTTP Authentication."]
    ERR_MISSING_AUTH_CREDENTIALS = -341,
    #[doc = " An unexpected, but documented, SSPI or GSSAPI status code was returned."]
    ERR_UNEXPECTED_SECURITY_LIBRARY_STATUS = -342,
    #[doc = " The environment was not set up correctly for authentication (for\n example, no KDC could be found or the principal is unknown."]
    ERR_MISCONFIGURED_AUTH_ENVIRONMENT = -343,
    #[doc = " An undocumented SSPI or GSSAPI status code was returned."]
    ERR_UNDOCUMENTED_SECURITY_LIBRARY_STATUS = -344,
    #[doc = " The HTTP response was too big to drain."]
    ERR_RESPONSE_BODY_TOO_BIG_TO_DRAIN = -345,
    #[doc = " The HTTP response contained multiple distinct Content-Length headers."]
    ERR_RESPONSE_HEADERS_MULTIPLE_CONTENT_LENGTH = -346,
    #[doc = " HTTP/2 headers have been received, but not all of them - status or version\n headers are missing, so we're expecting additional frames to complete them."]
    ERR_INCOMPLETE_HTTP2_HEADERS = -347,
    #[doc = " No PAC URL configuration could be retrieved from DHCP. This can indicate\n either a failure to retrieve the DHCP configuration, or that there was no\n PAC URL configured in DHCP."]
    ERR_PAC_NOT_IN_DHCP = -348,
    #[doc = " The HTTP response contained multiple Content-Disposition headers."]
    ERR_RESPONSE_HEADERS_MULTIPLE_CONTENT_DISPOSITION = -349,
    #[doc = " The HTTP response contained multiple Location headers."]
    ERR_RESPONSE_HEADERS_MULTIPLE_LOCATION = -350,
    #[doc = " HTTP/2 server refused the request without processing, and sent either a\n GOAWAY frame with error code NO_ERROR and Last-Stream-ID lower than the\n stream id corresponding to the request indicating that this request has not\n been processed yet, or a RST_STREAM frame with error code REFUSED_STREAM.\n Client MAY retry (on a different connection).  See RFC7540 Section 8.1.4."]
    ERR_HTTP2_SERVER_REFUSED_STREAM = -351,
    #[doc = " HTTP/2 server didn't respond to the PING message."]
    ERR_HTTP2_PING_FAILED = -352,
    #[doc = " The HTTP response body transferred fewer bytes than were advertised by the\n Content-Length header when the connection is closed."]
    ERR_CONTENT_LENGTH_MISMATCH = -354,
    #[doc = " The HTTP response body is transferred with Chunked-Encoding, but the\n terminating zero-length chunk was never sent when the connection is closed."]
    ERR_INCOMPLETE_CHUNKED_ENCODING = -355,
    #[doc = " There is a QUIC protocol error."]
    ERR_QUIC_PROTOCOL_ERROR = -356,
    #[doc = " The HTTP headers were truncated by an EOF."]
    ERR_RESPONSE_HEADERS_TRUNCATED = -357,
    #[doc = " The QUIC crypto handshake failed.  This means that the server was unable\n to read any requests sent, so they may be resent."]
    ERR_QUIC_HANDSHAKE_FAILED = -358,
    #[doc = " Transport security is inadequate for the HTTP/2 version."]
    ERR_HTTP2_INADEQUATE_TRANSPORT_SECURITY = -360,
    #[doc = " The peer violated HTTP/2 flow control."]
    ERR_HTTP2_FLOW_CONTROL_ERROR = -361,
    #[doc = " The peer sent an improperly sized HTTP/2 frame."]
    ERR_HTTP2_FRAME_SIZE_ERROR = -362,
    #[doc = " Decoding or encoding of compressed HTTP/2 headers failed."]
    ERR_HTTP2_COMPRESSION_ERROR = -363,
    #[doc = " Proxy Auth Requested without a valid Client Socket Handle."]
    ERR_PROXY_AUTH_REQUESTED_WITH_NO_CONNECTION = -364,
    #[doc = " HTTP_1_1_REQUIRED error code received on HTTP/2 session."]
    ERR_HTTP_1_1_REQUIRED = -365,
    #[doc = " HTTP_1_1_REQUIRED error code received on HTTP/2 session to proxy."]
    ERR_PROXY_HTTP_1_1_REQUIRED = -366,
    #[doc = " The PAC script terminated fatally and must be reloaded."]
    ERR_PAC_SCRIPT_TERMINATED = -367,
    #[doc = " Signals that the request requires the IPP proxy."]
    ERR_PROXY_REQUIRED = -368,
    #[doc = " The server was expected to return an HTTP/1.x response, but did not. Rather\n than treat it as HTTP/0.9, this error is returned."]
    ERR_INVALID_HTTP_RESPONSE = -370,
    #[doc = " Initializing content decoding failed."]
    ERR_CONTENT_DECODING_INIT_FAILED = -371,
    #[doc = " Received HTTP/2 RST_STREAM frame with NO_ERROR error code.  This error should\n be handled internally by HTTP/2 code, and should not make it above the\n SpdyStream layer."]
    ERR_HTTP2_RST_STREAM_NO_ERROR_RECEIVED = -372,
    #[doc = " An HTTP transaction was retried too many times due for authentication or\n invalid certificates. This may be due to a bug in the net stack that would\n otherwise infinite loop, or if the server or proxy continually requests fresh\n credentials or presents a fresh invalid certificate."]
    ERR_TOO_MANY_RETRIES = -375,
    #[doc = " Received an HTTP/2 frame on a closed stream."]
    ERR_HTTP2_STREAM_CLOSED = -376,
    #[doc = " The server returned a non-2xx HTTP response code.\n\n Note that this error is only used by certain APIs that interpret the HTTP\n response itself. URLRequest for instance just passes most non-2xx\n response back as success."]
    ERR_HTTP_RESPONSE_CODE_FAILURE = -379,
    #[doc = " The certificate presented on a QUIC connection does not chain to a known root\n and the origin connected to is not on a list of domains where unknown roots\n are allowed."]
    ERR_QUIC_CERT_ROOT_NOT_KNOWN = -380,
    #[doc = " A GOAWAY frame has been received indicating that the request has not been\n processed and is therefore safe to retry on a different connection."]
    ERR_QUIC_GOAWAY_REQUEST_CAN_BE_RETRIED = -381,
    #[doc = " The ACCEPT_CH restart has been triggered too many times"]
    ERR_TOO_MANY_ACCEPT_CH_RESTARTS = -382,
    #[doc = " The IP address space of the remote endpoint differed from the previous\n observed value during the same request. Any cache entry for the affected\n request should be invalidated."]
    ERR_INCONSISTENT_IP_ADDRESS_SPACE = -383,
    #[doc = " The IP address space of the cached remote endpoint is blocked by private\n network access check."]
    ERR_CACHED_IP_ADDRESS_SPACE_BLOCKED_BY_LOCAL_NETWORK_ACCESS_POLICY = -384,
    #[doc = " The connection is blocked by private network access checks."]
    ERR_BLOCKED_BY_LOCAL_NETWORK_ACCESS_CHECKS = -385,
    #[doc = " Content decoding failed due to the zstd window size being too big (over 8MB)."]
    ERR_ZSTD_WINDOW_SIZE_TOO_BIG = -386,
    #[doc = " The compression dictionary cannot be loaded."]
    ERR_DICTIONARY_LOAD_FAILED = -387,
    #[doc = " The header of dictionary compressed stream does not match the expected value."]
    ERR_UNEXPECTED_CONTENT_DICTIONARY_HEADER = -388,
    #[doc = " The cache does not have the requested entry."]
    ERR_CACHE_MISS = -400,
    #[doc = " Unable to read from the disk cache."]
    ERR_CACHE_READ_FAILURE = -401,
    #[doc = " Unable to write to the disk cache."]
    ERR_CACHE_WRITE_FAILURE = -402,
    #[doc = " The operation is not supported for this entry."]
    ERR_CACHE_OPERATION_NOT_SUPPORTED = -403,
    #[doc = " The disk cache is unable to open this entry."]
    ERR_CACHE_OPEN_FAILURE = -404,
    #[doc = " The disk cache is unable to create this entry."]
    ERR_CACHE_CREATE_FAILURE = -405,
    #[doc = " Multiple transactions are racing to create disk cache entries. This is an\n internal error returned from the HttpCache to the HttpCacheTransaction that\n tells the transaction to restart the entry-creation logic because the state\n of the cache has changed."]
    ERR_CACHE_RACE = -406,
    #[doc = " The cache was unable to read a checksum record on an entry. This can be\n returned from attempts to read from the cache. It is an internal error,\n returned by the SimpleCache backend, but not by any URLRequest methods\n or members."]
    ERR_CACHE_CHECKSUM_READ_FAILURE = -407,
    #[doc = " The cache found an entry with an invalid checksum. This can be returned from\n attempts to read from the cache. It is an internal error, returned by the\n SimpleCache backend, but not by any URLRequest methods or members."]
    ERR_CACHE_CHECKSUM_MISMATCH = -408,
    #[doc = " Internal error code for the HTTP cache. The cache lock timeout has fired."]
    ERR_CACHE_LOCK_TIMEOUT = -409,
    #[doc = " Received a challenge after the transaction has read some data, and the\n credentials aren't available.  There isn't a way to get them at that point."]
    ERR_CACHE_AUTH_FAILURE_AFTER_READ = -410,
    #[doc = " Internal not-quite error code for the HTTP cache. In-memory hints suggest\n that the cache entry would not have been usable with the transaction's\n current configuration (e.g. load flags, mode, etc.)"]
    ERR_CACHE_ENTRY_NOT_SUITABLE = -411,
    #[doc = " The disk cache is unable to doom this entry."]
    ERR_CACHE_DOOM_FAILURE = -412,
    #[doc = " The disk cache is unable to open or create this entry."]
    ERR_CACHE_OPEN_OR_CREATE_FAILURE = -413,
    #[doc = " The server's response was insecure (e.g. there was a cert error)."]
    ERR_INSECURE_RESPONSE = -501,
    #[doc = " An attempt to import a client certificate failed, as the user's key\n database lacked a corresponding private key."]
    ERR_NO_PRIVATE_KEY_FOR_CERT = -502,
    #[doc = " An error adding a certificate to the OS certificate database."]
    ERR_ADD_USER_CERT_FAILED = -503,
    #[doc = " An error occurred while handling a signed exchange."]
    ERR_INVALID_SIGNED_EXCHANGE = -504,
    #[doc = " An error occurred while handling a Web Bundle source."]
    ERR_INVALID_WEB_BUNDLE = -505,
    #[doc = " A Trust Tokens protocol operation-executing request failed for one of a\n number of reasons (precondition failure, internal error, bad response)."]
    ERR_TRUST_TOKEN_OPERATION_FAILED = -506,
    #[doc = " When handling a Trust Tokens protocol operation-executing request, the system\n was able to execute the request's Trust Tokens operation without sending the\n request to its destination: for instance, the results could have been present\n in a local cache (for redemption) or the operation could have been diverted\n to a local provider (for \"platform-provided\" issuance)."]
    ERR_TRUST_TOKEN_OPERATION_SUCCESS_WITHOUT_SENDING_REQUEST = -507,
    #[doc = " This is a placeholder value that should never be used within //net.\n\n When Cronet APIs are being backed by HttpEngine (i.e., HttpEngineProvider is\n being used), org.chromium.net.NetworkException#getCronetInternalErrorCode is\n not supported (android.net.http.NetworkException#getCronetInternalErrorCode\n does not exist). In this scenario, getCronetInternalErrorCode will always\n return this error. This is a first step towards the deprecation of\n getCronetInternalErrorCode.\n\n Temporarily terminate, then restart, ITTT to avoid unsupported nesting.\n LINT.ThenChange(\n      //tools/metrics/histograms/enums.xml:HTTPResponseAndNetErrorCodes,\n      //tools/metrics/histograms/enums.xml:NetErrorCodes,\n )\n LINT.IfChange(HTTPENGINE_PROVIDER_IN_USE)"]
    ERR_HTTPENGINE_PROVIDER_IN_USE = -508,
    #[doc = " PKCS #12 import failed due to incorrect password."]
    ERR_PKCS12_IMPORT_BAD_PASSWORD = -701,
    #[doc = " PKCS #12 import failed due to other error."]
    ERR_PKCS12_IMPORT_FAILED = -702,
    #[doc = " CA import failed - not a CA cert."]
    ERR_IMPORT_CA_CERT_NOT_CA = -703,
    #[doc = " Import failed - certificate already exists in database.\n Note it's a little weird this is an error but reimporting a PKCS12 is ok\n (no-op).  That's how Mozilla does it, though."]
    ERR_IMPORT_CERT_ALREADY_EXISTS = -704,
    #[doc = " CA import failed due to some other error."]
    ERR_IMPORT_CA_CERT_FAILED = -705,
    #[doc = " Server certificate import failed due to some internal error."]
    ERR_IMPORT_SERVER_CERT_FAILED = -706,
    #[doc = " PKCS #12 import failed due to invalid MAC."]
    ERR_PKCS12_IMPORT_INVALID_MAC = -707,
    #[doc = " PKCS #12 import failed due to invalid/corrupt file."]
    ERR_PKCS12_IMPORT_INVALID_FILE = -708,
    #[doc = " PKCS #12 import failed due to unsupported features."]
    ERR_PKCS12_IMPORT_UNSUPPORTED = -709,
    #[doc = " Key generation failed."]
    ERR_KEY_GENERATION_FAILED = -710,
    #[doc = " Failure to export private key."]
    ERR_PRIVATE_KEY_EXPORT_FAILED = -712,
    #[doc = " Self-signed certificate generation failed."]
    ERR_SELF_SIGNED_CERT_GENERATION_FAILED = -713,
    #[doc = " The certificate database changed in some way."]
    ERR_CERT_DATABASE_CHANGED = -714,
    #[doc = " The certificate verifier configuration changed in some way."]
    ERR_CERT_VERIFIER_CHANGED = -716,
    #[doc = " DNS resolver received a malformed response."]
    ERR_DNS_MALFORMED_RESPONSE = -800,
    #[doc = " DNS server requires TCP"]
    ERR_DNS_SERVER_REQUIRES_TCP = -801,
    #[doc = " DNS transaction timed out."]
    ERR_DNS_TIMED_OUT = -803,
    #[doc = " The entry was not found in cache or other local sources, for lookups where\n only local sources were queried.\n TODO(ericorth): Consider renaming to DNS_LOCAL_MISS or something like that as\n the cache is not necessarily queried either."]
    ERR_DNS_CACHE_MISS = -804,
    #[doc = " Suffix search list rules prevent resolution of the given host name."]
    ERR_DNS_SEARCH_EMPTY = -805,
    #[doc = " Failed to sort addresses according to RFC3484."]
    ERR_DNS_SORT_ERROR = -806,
    #[doc = " Failed to resolve the hostname of a DNS-over-HTTPS server."]
    ERR_DNS_SECURE_RESOLVER_HOSTNAME_RESOLUTION_FAILED = -808,
    #[doc = " DNS identified the request as disallowed for insecure connection (http/ws).\n Error should be handled as if an HTTP redirect was received to redirect to\n https or wss."]
    ERR_DNS_NAME_HTTPS_ONLY = -809,
    #[doc = " All DNS requests associated with this job have been cancelled."]
    ERR_DNS_REQUEST_CANCELLED = -810,
    #[doc = " The hostname resolution of HTTPS record was expected to be resolved with\n alpn values of supported protocols, but did not."]
    ERR_DNS_NO_MATCHING_SUPPORTED_ALPN = -811,
    #[doc = " When checking whether secure DNS can be used, the response returned for the\n requested probe record either had no answer or was invalid."]
    ERR_DNS_SECURE_PROBE_RECORD_INVALID = -814,
    #[doc = " Returned when DNS cache invalidation is in progress. This is a\n transient error. Callers may want to retry later."]
    ERR_DNS_CACHE_INVALIDATION_IN_PROGRESS = -815,
    #[doc = " The DNS server responded with a format error response code."]
    ERR_DNS_FORMAT_ERROR = -816,
    #[doc = " The DNS server responded with a server failure response code."]
    ERR_DNS_SERVER_FAILURE = -817,
    #[doc = " The DNS server responded that the query type is not implemented."]
    ERR_DNS_NOT_IMPLEMENTED = -818,
    #[doc = " The DNS server responded that the request was refused."]
    ERR_DNS_REFUSED = -819,
    #[doc = " The DNS server responded with an rcode indicating that the request failed,\n but the rcode is not one that we have a specific error code for. In other\n words, the rcode was not one of the following:\n - NOERR\n - FORMERR\n - SERVFAIL\n - NXDOMAIN\n - NOTIMP\n - REFUSED"]
    ERR_DNS_OTHER_FAILURE = -820,
    #[doc = " The construction arguments are invalid. This is considered a bad IPC."]
    ERR_BLOB_INVALID_CONSTRUCTION_ARGUMENTS = -900,
    #[doc = " We don't have enough memory for the blob."]
    ERR_BLOB_OUT_OF_MEMORY = -901,
    #[doc = " We couldn't create or write to a file. File system error, like a full disk."]
    ERR_BLOB_FILE_WRITE_FAILED = -902,
    #[doc = " The renderer was destroyed while data was in transit."]
    ERR_BLOB_SOURCE_DIED_IN_TRANSIT = -903,
    #[doc = " The renderer destructed the blob before it was done transferring, and there\n were no outstanding references (no one is waiting to read) to keep the\n blob alive."]
    ERR_BLOB_DEREFERENCED_WHILE_BUILDING = -904,
    #[doc = " A blob that we referenced during construction is broken, or a browser-side\n builder tries to build a blob with a blob reference that isn't finished\n constructing."]
    ERR_BLOB_REFERENCED_BLOB_BROKEN = -905,
    #[doc = " A file that we referenced during construction is not accessible to the\n renderer trying to create the blob."]
